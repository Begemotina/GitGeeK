...
class Cell:
    def __init__(self, quantity: int):
        '''
            протосто класс клетки
        :param quantity: число ячеек в клетке.
        '''
        self.quantity = int(quantity)  # я плохо знаком с биологией, но думаю что если 0.6 ячейки это не ячейка.
    ...
    def __sub__(self, other):
        ...
        if int(self.quantity - other.quantity) > 0:
            result = int(self.quantity - other.quantity)
            return f"клетка уменьшилась {'*' * result}"
        else:
            return f"нельзя так уменьшать клетки!!!"
...
if __name__ == '__main__':
    ...
    print(cell_1) # а чего она не модифицировалась?  я бы хотел что бы она модифицировалсь....